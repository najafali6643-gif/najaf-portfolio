...
//         // Normal particle size: 0.4px - 1.2px
//         this.baseRadius = Math.random() * 0.8 + 0.4

//         // Each particle gets a different maximum size
//         this.maxRadius =
//           this.baseRadius *
//           (1.5 + Math.random() * 1.5)
...
//         // Different maximum brightness for each particle
//         this.maxAlpha =
...
//         // Different glow duration for every particle
//         this.glowSpeed =
//           Math.random() * 0.25 + 0.25

//         // First glow happens randomly within 0 - 3 seconds
//         this.glowDelay =
//           Math.random() * 3
//       }

//       updateGlow(dt) {
//         // Waiting for the next glow
//         if (!this.glowing) {
//           this.glowDelay -= dt
...
//           // Wait 2 - 10 seconds before glowing again
//           this.glowDelay =
//             Math.random() * 8 + 2
...
//          * 0 → 1 → 0
//          *
//          * This makes the particle grow and
//          * shrink smoothly instead of popping.
//          */
//         const t = Math.sin(
...
//         // Reset particle when it leaves the canvas
//         if (
//           this.x < 0 ||
//           this.x > width ||
//           this.y < 0 ||
...
//          * SOFT PARTICLE HALO
//          *
//          * The halo becomes larger and brighter
//          * while the particle is glowing.
//          */
//         if (glowT > 0) {
//           const glowRadius =
//             this.radius *
...
//          * SHARP PARTICLE CORE
//          *
//          * The center stays sharp while
//          * the surrounding halo stays soft.
//          */
//         ctx.beginPath()
...
//       /*
//        * Particle density:
//        * approximately 1 particle per 10,000px²
//        */
...
//        */
//       mouse.x +=
//         (mouse.targetX - mouse.x) * 0.05

//       mouse.y +=
//         (mouse.targetY - mouse.y) * 0.05
...
//         0,
//         hexToRgba(glowCss, 0.1),
//       )

//       cursorGradient.addColorStop(
//         0.5,
//         hexToRgba(glowCss, 0.015),
//       )
...
function ParticleBackground({
  ...
  useEffect(() => {
    ...
    // How quickly the trail disappears.
    const trailFade = 0.88
